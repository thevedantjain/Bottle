...
class ProjectFormLauncher: NSObject {
    ...
    let formView: ProjectFormView = {
        let view = ProjectFormView()
        view.translatesAutoresizingMaskIntoConstraints = false
    ...
    fileprivate func setupFormView(_ window: UIWindow) {
        ...
        formView.heightAnchor.constraint(equalToConstant: 226).isActive = true
